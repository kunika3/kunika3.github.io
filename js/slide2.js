...
function getFilteredData (states, vaccinedata, state) {
    ...
    // var sortedStates = states.features.filter(function(d){
    //     console.log(d)
    ...
    //         .merge(_.keyBy(vaccinedata, 'Province_State'))
    //         .values()
    //         .value();

    // console.log(states);

    // var sorted_countries_byvaccineState = states.features.filter(function(d){
    //     return d.properties.name === state;
    // });
